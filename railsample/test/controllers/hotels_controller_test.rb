...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post hotels_url, params: { hotel: { description: @hotel.description, rating: @hotel.rating, review: @hotel.review, title: @hotel.title } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { description: @hotel.description, rating: @hotel.rating, review: @hotel.review, title: @hotel.title } }
